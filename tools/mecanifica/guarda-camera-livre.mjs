...
try {
  ...
  const base = `http://127.0.0.1:${port}/nos-mecanifica/bancada.html?peca=freio-disco&vista=direita&projecao=ortografica`;
  ...
  await page.goto(`http://127.0.0.1:${port}/nos-mecanifica/bancada.html?peca=freio-disco&vista=livre&camera=NaN`, { waitUntil: 'load' });
