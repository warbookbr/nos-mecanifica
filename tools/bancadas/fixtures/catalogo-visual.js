...
export const portas = {
  ...
  PASSOS: [
    ...
    parte('caixa', { op: 'chamferBox', id: 400 }),
    publicar('soleiraDaJardineira', { op: 'chamferBox', id: 400 }),
    publicar('bordaDaFrenteDaSoleira', { op: 'chamferBox', id: 400, aresta: 3 }),
    ['plano', { origemId: 402, largura: 1.6, profundidade: 0.7, seg: 2 }],
    parte('terra', { op: 'plano', id: 402 }),
    publicar('leitoDaTerra', { op: 'plano', id: 402 }),
    publicar('faixaDaFrenteDaTerra', { op: 'plano', id: 402, faixa: 'ultima' }),
    ['transladar', { d: [0, 0.35, 0], sel: { origem: { op: 'plano', id: 402 } } }],
    ['esfera', { origemId: 401, raio: 0.25, aneis: 4, lados: 8 }],
    parte('bulbo', { op: 'esfera', id: 401 }),
    publicar('coloDoBulbo', { op: 'esfera', id: 401, faixa: 'ultima' }),
    ['cilindro', { origemId: 404, raio: 0.1, altura: 0.7, lados: 8 }],
    parte('caule', { op: 'cilindro', id: 404 }),
    ['publicarPorta', {
      id: 'peDoCaule', rotulo: 'Base enterrada do caule',
      de: { op: 'cilindro', id: 404, tampa: 'fundo' },
    }],
    publicar('coroaDoCaule', { op: 'cilindro', id: 404, tampa: 'topo' }),
    ['cone', { origemId: 405, raio: 0.18, altura: 0.3, lados: 8 }],
    parte('botao', { op: 'cone', id: 405 }),
    publicar('assentoDoBotao', { op: 'cone', id: 405, tampa: 'fundo' }),
  ],
};
