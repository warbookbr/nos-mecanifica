...
- `furo-raio-por-grupo.test.ts` — furo-raio-por-grupo.test.ts — contrato da F1/fatia 2: cada grupo de centros pode declarar o próprio raio, sem mudar a numeração, o modo de saída nem a ordem …
