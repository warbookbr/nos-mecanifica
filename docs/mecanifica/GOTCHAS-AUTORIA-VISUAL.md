...
| Teste que nunca foi visto falhando | Ele passa, e ninguém sabe se passa porque o código está certo ou porque ele não olha para o lugar certo. | Reintroduzir o defeito de propósito e confirmar que o teste reprova. Um teste nunca visto falhando é decoração. |
| Dependência pedida com história convincente | A história explica por que a biblioteca resolveria o problema, e soa boa o bastante para ninguém conferir se o problema é aquele mesmo. | A justificativa é EVIDÊNCIA, não narrativa: um defeito real que a biblioteca pegaria e o que existe hoje não pega. Sem isso, não entra. Registrado em 2026-08-26: a `fast-check` foi pedida com a história de que um cilindro deitado esconderia um defeito de orientação; ao conferir, o deitado também reprovava, e 1500 casos gerados não acharam nada. Ela saiu. |
