...
**Plano:** [`2026-08-23-arquitetura-hibrida-familias-modelagem-ia.md`](planos/2026-08-23-arquitetura-hibrida-familias-modelagem-ia.md)  
**Base:** `d99a639`
...
| RT-02 | descobrir capacidade antes de inventar operação | catálogo, schemas, combinação e lacunas — existente/provado | `docs/mecanifica/gerado/`, `tools/mcp/perfis/procedural.mjs` | `npm run catalogo:check`, `npm run mcp:ensaio` | N1; promover ou registrar lacuna |
...
| RT-05 | editar superfície por intenção/região | superfície semântica — proposto | `DOSSIE-MOTOR-SUPERFICIES-NATIVAS.md`; contrato a criar em N1/N3 | prova de duas representações, edição local, compilação e procedência | G02/G07; escolher, corrigir ou descartar |
...
| RT-07 | decompor sem perder a forma global | regiões, fronteiras e fonte derivada — proposto | contrato de receita elevada e pacote de família | comparação antes/depois, IDs e influência fonte→produto | G03/G04; aceitar ou redesenhar |
...
| RT-11 | dar à IA um caminho único | orquestrador de autoria — proposto | `DOSSIE-PLATAFORMA-AUTORIA-3D-NATIVA.md` e serviços a criar | cliente caixa-preta observa→planeja→compila→valida→revisa | N1/N7; serviço aprovado ou bloqueado |
...
| N1 contrato | matriz, lacunas, dossiês e serviços existentes | schemas, estados, fonte/derivado, diagnóstico e plano de prova | RT-02, RT-05, RT-07, RT-11 | sim, se contratos executáveis |
