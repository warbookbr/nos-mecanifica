...
- **Parâmetros:**
  - `arquivo` (string, obrigatório): Caminho do arquivo `.js` relativo à raiz do repositório (ex: `prototipos/procedural/v3/pecas/bicicleta-quadro/receita.js`).
...
```powershell
npm run ativar:bancada -- --arquivo=prototipos/procedural/v3/pecas/bicicleta-quadro/receita.js
```
...
|---|---|---|
| `--arquivo=<caminho>` | Caminho do arquivo `.js` da receita | `--arquivo=prototipos/procedural/v3/pecas/bicicleta-quadro/receita.js` |
