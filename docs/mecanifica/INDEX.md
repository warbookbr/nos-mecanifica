...
Não há plano ativo. Os Recortes A–F de `AUT-05` foram concluídos em
...
faixa declarada aro↔pneu. Nenhum deles chama alerta amplo de colisão exata.
Hierarquia, múltiplas relações, persistência e solver continuam candidatos. O plano mestre foi
...
Os caminhos canônicos dos seis recortes são
...
`docs/mecanifica/planos/2026-08-02-assentamento-anular.md`.
