...
- O único plano **ativo** é a [modelagem dirigida pelo usuário](planos/2026-08-26-modelagem-dirigida-pelo-usuario.md).
  Ele separa as duas tarefas por dono: o usuário decide se a forma está boa,
  dizendo em linguagem comum o que está errado, e a IA executa a correção
  alterando grandezas com nome. Nenhuma métrica aprova forma. O laço está na
  skill `.claude/skills/modelar-dirigido/SKILL.md`, e a base é
  `autoria-assistida/experimentos/prova-cage-quarto-dianteiro/`, retirada da
  quarentena de rascunhos por ser a única peça aceita pelo usuário.
- O [modelador inverso com priors por família](planos/congelados/2026-08-25-modelador-inverso-priors-familia.md)
  foi **congelado**, não refutado: sua primeira fase existia para provar que uma
  IA julga forma de modo confiável, e essa pergunta saiu do caminho crítico
  quando o usuário assumiu o julgamento. A pasta
  [`planos/congelados/`](planos/congelados/README.md) define o estado e cada
  plano lá declara sua condição de descongelamento. Dele foram herdadas a
  qualificação de alvo, a regra de julgar cada vista separada e grande, e os
  recortes regionais N6. Seu [dossiê](DOSSIE-MODELADOR-INVERSO-PRIORS-FAMILIA.md)
  e a infraestrutura de calibração cega em `tools/modelagem/` continuam no
  repositório, verdes e sem consumidor ativo.
- O plano por seleção foi cancelado: sua capacidade de comparação não tinha
  calibração repetida, o gerador restringia o espaço alcançável e o alvo N6 é
  direção estética sem câmeras/correspondências geométricas. N0–N6, R2B, seleção
  por linhas e o canário de silhuetas permanecem evidência histórica, não
  continuidade.
