...
R3 não mede se outro agente, sem contexto, consegue criar e revisar uma prancha inédita, nem compara uma modelagem 3D orientada pelo alvo. Não há mecanismo honesto que substitua essas provas locais: ambas pertencem à R4. A próxima rodada precisa separar autor e revisor e usar só portas e documentação públicas. A evidência parcial da R4 está em [RELATORIO-MOTOR-DE-PRANCHA-R4.md](RELATORIO-MOTOR-DE-PRANCHA-R4.md) (`docs/mecanifica/historico/RELATORIO-MOTOR-DE-PRANCHA-R4.md`).
