...
- medir contexto, retomada e ausência de promoção automática. **Resultado:** concluída com estudo multi-raiz, troca de identidade, obsolescência de campanha e retomada MCP; relatório em `docs/mecanifica/historico/RELATORIO-R05-REVALIDACAO-CAMPO.md`.
