...
Candidatos ligados à nova direção de autoria precisam respeitar as invariantes
de [`AUTORIA-IA.md`](../AUTORIA-IA.md) e
...
| Produto cliente | cena, narrativa e experiência devem apontar para `warbookbr/mecanica`; autoria de peças e montagens permanece neste repositório |
