...
| `AUT-05` — posição, encaixe e hierarquia semânticos | O-7, O-8, O-10, A-16, A-29 e [`MONTAGENS-SEMANTICAS.md`](../MONTAGENS-SEMANTICAS.md) | Recortes A e B concluídos em [`AUT-2026-06`](2026-08-02-interfaces-de-encaixe.md) e [`AUT-2026-07`](2026-08-02-pose-derivada-roda.md); pai, espelho, persistência, hierarquia e degraus seguintes continuam candidatos |
