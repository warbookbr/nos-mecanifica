...
| `AUT-05` — posição, encaixe e hierarquia semânticos | O-7, O-8, O-10, A-16, A-29 e [`MONTAGENS-SEMANTICAS.md`](../MONTAGENS-SEMANTICAS.md) | Recorte A concluído em [`AUT-2026-06`](2026-08-02-interfaces-de-encaixe.md); pose, hierarquia e os degraus seguintes continuam candidatos sem autorização |
