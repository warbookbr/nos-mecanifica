...
| Auditoria de interseções em montagens | plano ativo em `2026-08-18-auditoria-intersecoes-montagem.md`; malha neutra, contenção, cobertura explícita e MCP, sem solver ou folga universal |
