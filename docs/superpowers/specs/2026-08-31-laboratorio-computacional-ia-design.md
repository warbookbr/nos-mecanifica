...
**Data:** 2026-08-31  
**Estado:** desenho aprovado para incubação experimental  
**Branch de incubação:** `experimento/laboratorio-ia`  
**Base:** `origin/main` em `b6367ed`  
**Escopo:** especificação arquitetural; não autoriza promoção ao núcleo

## 1. Decisão

A Mecanifica passa a incubar, em branch e worktree isolados, um laboratório
...
Enquanto incubado, remover o worktree ou abandonar a branch elimina todo impacto
operacional sobre a Mecanifica. Após eventual promoção, cada adaptador permanece
...
- a incubação ocorre dentro da branch, em subsistema extraível;
