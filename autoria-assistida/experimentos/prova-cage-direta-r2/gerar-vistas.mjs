...
/* A B0 rejeitada permanece imutável: cada rodada escolhe sua própria pasta. */
const destino = path.join(aqui, 'evidencias', process.argv[2] ?? 'forma-global-r2b-b1'); mkdirSync(destino, { recursive: true });
