...
```bash
node autoria-assistida/rascunhos-defeituosos/estudo-campo-conjunto-dianteiro/executar-estudo.mjs --disco-raio=0.140 --resumo
node autoria-assistida/rascunhos-defeituosos/estudo-campo-conjunto-dianteiro/executar-estudo.mjs --disco-raio=0.165 --resumo
```
