...
- `node autoria-assistida/rascunhos-defeituosos/estudo-conjunto-dobradica/executar-estudo.mjs` — passou: três peças, 0 faces sem parte, 3/3 relações;
- `node autoria-assistida/rascunhos-defeituosos/estudo-conjunto-dobradica/auditar-visual.mjs` — executou nove capturas sem erro de página;
