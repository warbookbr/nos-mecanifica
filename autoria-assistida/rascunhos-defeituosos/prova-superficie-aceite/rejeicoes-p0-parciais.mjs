/* rejeicoes-p0-parciais.mjs — executa somente os critérios P0 alcançáveis pelo quarto dianteiro privado. */
...
export function rejeicoesParciais() {
  ...
  const topoDoArco = pele.V.get(arco.loop[Math.floor(arco.loop.length / 2)]);
  const itens = [
