#!/usr/bin/env node
/* gerar-consulta-arco.mjs — materializa consultas isoladas do arco para modelador e crítico. */
...
const entrada = (id, classe, nome) => {
  ...
  return { id, classe, regiao: 'arco-dianteiro', vista: 'lateral', arquivo: `repo://autoria-assistida/rascunhos-defeituosos/prova-superficie-aceite/evidencias/${nome}`, sha256: hashDoArquivo(absoluto) };
};
const entradas = [
